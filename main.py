...
# Canal del bot
BOT_CHANNEL = "@Shadowprojects1ro" # Reemplaza con el nombre de usuario de tu canal
...
@pyrogram.Client.on_chat_member_updated(pyrogram.filters.chat_member_updated.new_chat_member)
