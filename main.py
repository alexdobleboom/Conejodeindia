...
async def compress_video(client, message: Message):
    if message.reply_to_message and message.reply_to_message.video:
        ...
        await client.send_message(chat_id=message.chat.id, text="Elige una opción para la compresión:\n\n1. Alta calidad (Resolución 1080p, Bitrate 1Mbps)\n2. Media calidad (Resolución 720p, Bitrate 500kbps)\n3. Baja calidad (Resolución 480p, Bitrate 250kbps)")

        # Esperar la respuesta del usuario
        try:
            response = await client.listen(message.chat.id, timeout=30)
        except TimeoutError:
            await client.send_message(chat_id=message.chat.id, text="Tiempo de espera agotado. Intenta nuevamente.")
            return
        ...
        if response.text == "1":
            ...
            await client.send_message(chat_id=message.chat.id, text="Opción inválida. Intenta nuevamente.")
            return
