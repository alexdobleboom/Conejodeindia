...
from pyrogram.errors.exceptions.flood_420 import PeerFloodError # Importación corregida
from pyrogram.errors.exceptions.bad_request_400 import UserPrivacyRestrictedError
...
CHANNEL_USERNAME = "@tu_canal_de_telegram" # Reemplaza con el nombre de usuario de tu canal
ADMIN_USERNAME = "@tu_nombre_de_usuario" # Reemplaza con el nombre de usuario del administrador
...
SUPER_ADMINS = [1234567890] # Reemplaza con tu ID de usuario
ADMINS = [1234567890] # Reemplaza con las IDs de usuario de los administradores
